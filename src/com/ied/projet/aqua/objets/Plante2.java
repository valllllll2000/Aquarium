...
public class Plante2 extends Texture

{
	...
	private static float lightAngle=50.0f;
	//x de -4 a 4
	//y de -5 a 5
	float add=0.01f;
	float mAngle;
	...
	public Plante2() {
		...
		float vertices[] = { 0f, -8.0f, 1.0f, -8.0f, 0f, 2.0f, 1.0f, 2.0f };
	...
	public void draw(GL10 gl) {
		...
		gl.glRotatef(mAngle, 0f, 0.0f, 2f);
		mAngle += plusAngle;
		if (mAngle > 2 || mAngle < -2)
			plusAngle *= (-1);
